...
import linkit.base.api.resource.exception._
import linkit.base.api.resource.representation.ResourceRepresentation
import linkit.base.api.resource.ResourcesMaintainer
 ...
 *
 * @see [[linkit.base.api.resource.RemoteResourceRepresentation]]
 * */
trait ResourceFolder extends Resource {
     ...
     */
    override def getParent: Option[ResourceFolder]
