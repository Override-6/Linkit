...
public enum BasicInvocationRule implements RemoteInvocationRule {
     ...
     */
    ONLY_CURRENT((agreement) -> agreement
     ...
     */
    ONLY_ORIGIN((agreement) -> agreement
            /*agreement.discardAll()
                    .accept(OwnerEngine())
     ...
     */
    ONLY_CACHE_OWNER((agreement) -> agreement
            /*agreement.discardAll()
     ...
     */
    NOT_CURRENT(((agreement) -> agreement
     ...
     * The return value of the invocation will come from the current machine.
     */
    BROADCAST_IF_ORIGINAL((agreement) -> agreement
            /*agreement
     ...
     * The return value of the invocation will come from the current machine.
     */
    BROADCAST_IF_ROOT_OWNER((agreement -> agreement
     ...
     * The return value of the invocation will come from the current machine.
     */
    CURRENT_AND_ORIGIN(((agreement) -> agreement /*agreement.discardAll()
            .accept(CurrentEngine())
            .accept(OwnerEngine())
            .appointReturn(CurrentEngine()))*/));
