...
trait ObjectPersistor[A] {
    ...
    def getSerialNode(obj: A, desc: SerializableClassDescription, context: PacketPersistenceContext, progress: PacketSerialisationProgression): ObjectSerializerNode
