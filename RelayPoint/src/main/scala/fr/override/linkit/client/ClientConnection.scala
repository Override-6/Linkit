...
class ClientConnection(socket: DynamicSocket,
    ...
    override val identifier: String = configuration.identifier
    override val boundIdentifier: String = serverIdentifier
    override val translator: PacketTranslator = new CompactedPacketTranslator(identifier, configuration.securityManager)
    override val traffic: PacketTraffic = new SocketPacketTraffic(this, socket, identifier)
    override val network: Network = initNetwork
    override val eventNotifier: EventNotifier = new SimpleEventNotifier
    ...
    private def initNetwork: Network = {
        ...
        val globalCache = AbstractSharedCacheManager.get(identifier, identifier)(traffic)
    ...
    private object PointPacketWorkerThread extends PacketWorkerThread() {
        ...
        private val packetReader = new PacketReader(socket, configuration.securityManager)
