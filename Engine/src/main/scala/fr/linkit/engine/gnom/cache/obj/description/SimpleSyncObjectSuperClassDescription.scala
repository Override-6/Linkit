...
package fr.linkit.engine.gnom.cache.obj.description
...
import fr.linkit.engine.gnom.cache.obj.description.SimpleSyncObjectSuperClassDescription.SyntheticMod
import fr.linkit.engine.gnom.cache.obj.generation.SyncObjectClassResource.{WrapperPackage, WrapperSuffixName}
