...
import fr.linkit.engine.internal.compilation.{ClassCompilationRequestFactory, RuntimeClassOperations}
...
object SyncClassCompilationRequestFactory
    extends ClassCompilationRequestFactory[SyncObjectDescription[_], SynchronizedObject[_]](
        new SyncClassBlueprint(classOf[LinkitApplication].getResourceAsStream("/generation/sync_object.scbp"))) {

    override def loadClass(req      : CompilationRequest[SynchronizedObject[_]],
