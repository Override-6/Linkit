...
import fr.linkit.api.gnom.persistence.PacketSerializer
...
import fr.linkit.api.application.packet.{BroadcastPacketCoordinates, DedicatedPacketCoordinates, PacketCoordinates}
import fr.linkit.engine.gnom.persistence.MalFormedPacketException
import fr.linkit.engine.gnom.persistence.serializor.DefaultPacketSerializer.{BroadcastedFlag, DedicatedFlag}
