...
import fr.linkit.api.gnom.packet.channel.request.{RequestPacketBundle, RequestPacketChannel, Submitter}
import fr.linkit.api.gnom.packet.{DedicatedPacketCoordinates, PacketAttributes, PacketCoordinates}
