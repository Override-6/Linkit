...
package fr.linkit.engine.gnom.cache.obj.generation.rectifier
...
import fr.linkit.engine.gnom.cache.obj.generation.rectifier.ClassRectifier.{StringToPrimitiveID, SuperMethodModifiers}
