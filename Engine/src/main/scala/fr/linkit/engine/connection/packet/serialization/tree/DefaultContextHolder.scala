...
import fr.linkit.api.connection.packet.serialization.tree.{ContextHolder, DeserialNode, NodeFactory, SerialNode}
...
class DefaultContextHolder extends ContextHolder {
    ...
    private def getDefaultFactory[T](info: ByteSeq): Option[NodeFactory[T]] = {
...
object DefaultContextHolder {
    ...
    class ClassProfile[T](clazz: Class[T], context: DefaultContextHolder) {
