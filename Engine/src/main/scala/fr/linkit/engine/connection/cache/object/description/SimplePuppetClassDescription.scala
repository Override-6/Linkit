...
package fr.linkit.engine.connection.cache.`object`.description
...
import fr.linkit.engine.connection.cache.`object`.description.SimplePuppetClassDescription.SyntheticMod
