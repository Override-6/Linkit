...
package fr.linkit.engine.connection.cache.`object`.generation
...
import fr.linkit.engine.connection.cache.`object`.generation.WrapperCompilationRequestFactory.DefaultClassBlueprint
import fr.linkit.engine.connection.cache.`object`.generation.bp.ScalaWrapperClassBlueprint
import fr.linkit.engine.connection.cache.`object`.generation.rectifier.ClassRectifier
