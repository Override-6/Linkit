...
package fr.linkit.engine.connection.cache.`object`.generation.rectifier
...
import fr.linkit.engine.connection.cache.`object`.generation.rectifier.ClassRectifier.SuperMethodModifiers
