...
package fr.linkit.engine.connection.cache.`object`.generation.bp
...
import fr.linkit.engine.connection.cache.`object`.generation.bp.ScalaBlueprintUtilities._
import fr.linkit.engine.connection.cache.`object`.generation.bp.ScalaWrapperMethodBlueprint.ValueScope
