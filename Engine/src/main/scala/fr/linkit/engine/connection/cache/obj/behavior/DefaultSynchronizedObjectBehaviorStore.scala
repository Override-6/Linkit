...
class DefaultSynchronizedObjectBehaviorStore(override val factory: MemberBehaviorFactory) extends SynchronizedObjectBehaviorStore {
    ...
    private def getFromAnyClass[B <: AnyRef](clazz: Class[_]): SynchronizedObjectBehavior[B] = {
        behaviors.getOrElseUpdate(clazz, DefaultSynchronizedObjectBehavior[B](SimpleSyncObjectSuperClassDescription[B](clazz), this, null, null, null))
    ...
    override def modifyField(isCurrentOwner: Boolean, fieldValue: Any, defaultBhv: FieldBehavior[Any], enclosingClass: SynchronizedObjectBehavior[_]): FieldBehavior[Any] = ???

    override def modifyReturnValue(isCurrentOwner: Boolean, returnValue: Any, defaultBhv: ReturnValueModifier[Any], enclosingClass: SynchronizedObjectBehavior[_]): ReturnValueModifier[Any] = ???

    override def modifyParameter(isCurrentOwner: Boolean, paramValue: Any, defaultBhv: ParameterModifier[Any], enclosingClass: SynchronizedObjectBehavior[_]): ParameterModifier[Any] = ???
}