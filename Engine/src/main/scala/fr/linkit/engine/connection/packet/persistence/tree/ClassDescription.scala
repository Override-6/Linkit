...
import fr.linkit.api.connection.packet.persistence.tree.SerializableClassDescription.Fields
import fr.linkit.engine.connection.packet.persistence.tree.ClassDescription.Synthetic
