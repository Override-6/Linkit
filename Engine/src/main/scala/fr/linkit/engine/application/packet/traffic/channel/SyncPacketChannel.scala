...
import fr.linkit.api.application.packet.traffic.{PacketInjectableFactory, PacketInjectableStore, PacketSender, PacketSyncReceiver}
import fr.linkit.api.application.packet.{ChannelPacketBundle, Packet, PacketAttributes}
