...
import fr.linkit.api.application.packet.{DedicatedPacketCoordinates, Packet, PacketAttributes, PacketBundle}
import fr.linkit.api.internal.system.{ClosedException, Reason}
import fr.linkit.engine.application.packet.SimplePacketBundle
import fr.linkit.engine.gnom.persistence.context.{ImmutablePersistenceContext, PersistenceConfigBuilder}
import fr.linkit.engine.application.packet.traffic.injection.ParallelInjectionContainer
