...
package fr.linkit.engine.application.packet.traffic.channel.request

import fr.linkit.api.application.packet.ChannelPacketBundle
...
import fr.linkit.api.application.packet.channel.request.{RequestPacketBundle, RequestPacketChannel, ResponseHolder, Submitter}
...
import fr.linkit.engine.application.packet.traffic.channel.AbstractPacketChannel
