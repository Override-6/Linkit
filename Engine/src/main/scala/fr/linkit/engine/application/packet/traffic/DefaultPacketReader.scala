...
import fr.linkit.api.gnom.persistence.{PacketDeserializationResult, PacketTranslator}
import fr.linkit.api.application.packet.traffic.{PacketReader, PacketTraffic}
