...
import fr.linkit.api.application.packet.channel.request.{RequestPacketBundle, RequestPacketChannel, Submitter}
import fr.linkit.api.application.packet.{DedicatedPacketCoordinates, PacketAttributes, PacketCoordinates}
